      ...
      <div className="py-8 sm:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="bento-grid-container">
            ...
            <div className="bento-card bg-white p-6 sm:p-10 hover:bg-gray-50 transition-colors duration-300" style={{ gridColumn: 'span 2', gridColumnEnd: 'span 2' }}>
            ...
            <div className="bento-card bento-card-tall bg-white p-6 sm:p-10 hover:bg-gray-50 transition-colors duration-300 flex flex-col" style={{ gridColumn: 'span 1', gridColumnEnd: 'span 1', backgroundImage: 'url(https://i.postimg.cc/jdQY0jgT/Full-Body-Picture-14.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="bento-card bg-white p-6 sm:p-10 hover:bg-gray-50 transition-colors duration-300" style={{ gridColumn: 'span 3', gridColumnEnd: 'span 3' }}>
              <div className="relative z-10">
            ...
            <div className="bento-card bg-[#25201f] p-6 sm:p-10 text-white hover:bg-[#2a2520] transition-colors duration-300" style={{ gridColumn: 'span 3', gridColumnEnd: 'span 3', backgroundImage: 'url(https://i.postimg.cc/J7HRgMCX/Full-Body-Picture-15.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
