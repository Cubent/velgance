    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-center gap-8 pt-6 pb-8 lg:pt-12 lg:pb-12">
        ...
        <div className="flex flex-col gap-6 relative">
          ...
          <Button
            variant="outline"
            className="px-8 py-5 text-lg font-medium sm:px-8 sm:py-5 sm:text-lg transition-all duration-200 group"
          ...
          >
            <Link
              ...
              className="group-hover:bg-[#2a2a2a] group-hover:text-[#faf9f6] transition-all duration-200"
              style={{ backgroundColor: '#faf9f6', borderColor: '#faf9f6' }}
              onMouseEnter={(e) => {
