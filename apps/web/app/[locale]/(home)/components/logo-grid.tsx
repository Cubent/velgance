...
export const LogoGrid = () => {
  ...
  return (
    <div className="w-full overflow-hidden py-8" style={{ backgroundColor: '#161616' }}>
      {/* Match the width of the hero box */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative w-full overflow-hidden">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to right, rgba(22, 22, 22, 1), transparent)'
            }}
          />
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to left, rgba(22, 22, 22, 1), transparent)'
            }}
          />

          {/* Scrolling container - show 5 items */}
          <div className="flex gap-12 animate-scroll">
            {/* First set of logos - only show first 5 */}
