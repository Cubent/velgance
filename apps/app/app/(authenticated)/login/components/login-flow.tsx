...
export const LoginFlow = ({ deviceId, state, user }: LoginFlowProps) => {
  ...
  if (isComplete) {
    return (
      <div className="relative min-h-full w-full overflow-hidden" style={{backgroundColor: '#1a1a1a'}}>
          ...
          <Card className="w-full max-w-md bg-[#1a1a1a] border-[#333]">
            ...
            <CardContent className="text-center space-y-4">
              ...
              <Button
                ...
                className="w-full bg-transparent hover:bg-transparent text-white border border-gray-600 hover:border-gray-500"
              >
                Back to Dashboard
              </Button>
            </CardContent>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              className="border-[#333] bg-transparent data-[state=checked]:bg-transparent data-[state=checked]:border-[#333] data-[state=checked]:text-white h-4 w-4 [&[data-state=checked]]:bg-transparent"
            />
            <label
              htmlFor="terms"
